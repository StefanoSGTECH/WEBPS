...
@Component({
  ...
  templateUrl: './report-generale.component.html',
  styleUrls: ['./report-generale.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class ReportGeneraleComponent implements OnInit{
  ...
  onFiltro(tipoi: string): void {
    ...
    this._report.generale(this.selected.value.start, this.selected.value.end, tipoi).subscribe((resp) => {
